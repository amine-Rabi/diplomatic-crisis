...
export default function Leaderboard({ onBack }: Props) {
  ...
  const load = async () => {
    ...
    try {
      ...
      console.error(e);
      setError("The diplomatic record is sealed on this chain. Has the contract been deployed?");
    }
  };
      ...
      <div className="max-w-3xl mx-auto mt-8">
        <div className="doc-card px-8 sm:px-12 py-10 ink-rise">
          <div className="text-center mb-8">
            <div className="stamp mb-3">Bureau Hall of Cables</div>
            ...
            <div className="font-mono uppercase" style={{ color: "var(--dc-gold-deep)", fontSize: 11, letterSpacing: "0.4em", marginTop: 8 }}>
              Top Delegates · All-Time XP
            </div>
          ...
          {entries !== null && entries.length === 0 && (
            ...
            >
              ...
              <p className="prose-court italic" style={{ color: "var(--pc-ink-muted)" }}>
                No diplomat has yet been entered into the record.
              </p>
            </div>
          )}
